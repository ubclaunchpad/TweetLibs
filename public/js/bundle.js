...
var _MyForm = __webpack_require__(30);

var _MyForm2 = _interopRequireDefault(_MyForm);

var _Tweet = __webpack_require__(35);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.handleSubmitHome = _this.handleSubmitHome.bind(_this);
    _this.handleSubmitForm = _this.handleSubmitForm.bind(_this);
    _this.handleTwitterUserChange = _this.handleTwitterUserChange.bind(_this);
  ...
  _createClass(App, [{
    key: 'handleSubmitHome',
    value: function handleSubmitHome(e) {
      e.preventDefault();
      this.fetchData();
    }
  }, {
    ...
    value: function handleSubmitForm(e) {
      ...
      var values = Array.from(document.querySelectorAll("input")).map(function (e) {
        return e.value;
      });

      var tweetText = this.state.tweet.text;
      ...
      this.setState({ 'page': 'tweet', tweet: tweet });
    }
  }, {
    key: 'handleTwitterUserChange',
    value: function handleTwitterUserChange(e) {
    ...
    value: function fetchData() {
      ...
      fetch('http://35.227.181.45/api/tweet?twitter_user=' + this.state.twitter_user).then(function (resp) {
        return resp.json();
      }).then(function (data) {
        // store labels (adjective, noun etc) in this.state.labels
        _this2.setState({ 'labels': _this2.parseNewText(data.new_text) });
        _this2.setState({ 'tweet': _this2.getTweetData(data) });
        _this2.setState({ 'page': 'myform' });
    ...
    key: 'parseNewText',
    value: function parseNewText(text) {
    ...
    key: 'getTweetData',
    value: function getTweetData(data) {
      return {
    ...
    value: function render() {
      ...
      if (this.state.page == 'myform') {
        Content = _react2.default.createElement(
          _MyForm2.default,
          { onSubmit: this.handleSubmitForm, labels: this.state.labels },
          ' '
        );
      } else if (this.state.page == 'tweet') {
        Content = _react2.default.createElement(_Tweet2.default, { tweet: this.state.tweet });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { className: 'logo', src: 'https://www.sketchappsources.com/resources/source-image/twitterlogo_1x.png' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'center' },
...
var _SingleInput = __webpack_require__(31);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement("img", { className: "tweet-avatar", src: this.props.tweet.avatarURL }),
                        _react2.default.createElement(
                            "div",
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "tweet-author-screenname" },
